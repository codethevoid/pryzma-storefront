  ...
  return (
    <div className="p-4 py-12">
      <div className="prose prose-sm mx-auto max-w-screen-md dark:prose-invert">
        ...
        <p>This policy is effective as of March 1, 2023</p>
        ...
        <p>
          ...
          required to provide you with a particular service or offer (for example processing and
          fulfilling orders), we will not deny you goods or services and/or charge you different
