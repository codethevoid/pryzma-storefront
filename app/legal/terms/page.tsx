  ...
  return (
    <div className="p-4 py-12">
      <div className="prose prose-sm mx-auto max-w-screen-md dark:prose-invert">
        <h2>Pryzma Terms of Service</h2>
        <p>
          These Terms of Service govern your use of the website located at{" "}
          <a href="https://pryzma.io">https://pryzma.io</a> and any related services provided by
          Pryzma.
        </p>
        <p>
          By accessing <a href="https://pryzma.io">https://pryzma.io</a>, you agree to abide by
          ...
          website or using any other services provided by Pryzma.
        </p>
        <p>
          We, Pryzma, reserve the right to review and amend any of these Terms of Service at our
        ...
        <p>These Terms of Service were last updated on May 12, 2024.</p>
        ...
        <ul>
          ...
          <li>
            ...
            that abuses or disrupts our networks or any other service Pryzma provides;
          </li>
          <li>
        ...
        <p>
          ...
          licensed to Pryzma and are protected by applicable copyright and trademark law. We grant
        ...
        <p>
          ...
          and may be terminated by Pryzma at any time.
        </p>
        <h3>Liability</h3>
        <p>
        ...
        <p>
          In no event shall Pryzma or its suppliers be liable for any consequential loss suffered or
          incurred by you or any third party arising from the use or inability to use this website
          or the materials on this website, even if Pryzma or an authorized representative has been
        ...
        <p>
          ...
          information purposes only. Pryzma does not warrant or make any representations concerning
        ...
        <h3>Links</h3>
        <p>
          Pryzma has not reviewed all of the sites linked to its website and is not responsible for
          the contents of any such linked site. The inclusion of any link does not imply
          endorsement, approval or control by Pryzma of the site. Use of any such linked site is at
        ...
        <h3>Governing Law</h3>
        <p>
          These Terms of Service are governed by and construed in accordance with the laws of Ohio.
