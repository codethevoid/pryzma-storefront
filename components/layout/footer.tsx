    ...
    <div className="border-t bg-zinc-50 px-4 py-8 dark:bg-zinc-900/50">
      <div className="mx-auto max-w-screen-xl space-y-8">
          ...
          <div className="col-span-3 space-y-4">
            ...
            <div className="flex gap-2">
              <IconButton size="small" variant="primary" asChild>
                <a
                  href="https://www.instagram.com/pryzma.io"
                  target="_blank"
                  rel="noreferrer"
              ...
              <IconButton size="small" variant="primary" asChild>
                <a
                  href="https://www.threads.net/@pryzma.io"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Threads"
                >
              ...
              <IconButton size="small" variant="primary" asChild>
                <a
                  href="https://www.youtube.com/@pryzma_io"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="YouTube"
                >
              ...
              <IconButton size="small" variant="primary" asChild>
                <a href="https://x.com/pryzmadotio" target="_blank" rel="noreferrer" aria-label="X">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
        ...
        <div className="flex items-center justify-between">
          <Text size="xsmall" className="text-subtle-foreground">
            &copy; {new Date().getFullYear()} Pryzma. All rights reserved.
          </Text>
          <ThemeToggle />
        </div>
      </div>
